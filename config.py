...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABASE_URI', f'sqlite:///{os.path.join(instance_path, "dev.db")}')
...
class ProductionConfig(Config):
    ...
    instance_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'instance')
    os.makedirs(instance_path, exist_ok=True)
    SQLALCHEMY_DATABASE_URI = os.environ.get('TEMPLATE_DATABASE_URI', os.environ.get('DATABASE_URI', f'sqlite:///{os.path.join(instance_path, "prod.db")}'))
